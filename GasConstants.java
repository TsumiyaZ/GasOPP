...
public class GasConstants {
    ...
    public static final Color COLOR_WINDOW = new Color(196, 217, 255);
    public static final Color COLOR_WINDOW_SOUTH = new Color(232, 249, 255);
    ...
    public static final String[] PICTURE_ABOUT = {"PICTURE1.jpg", "PictureMenu.jpg", "PICTURE1.jpg"};
}